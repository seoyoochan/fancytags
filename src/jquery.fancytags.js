		...
		$.extend(Plugin.prototype, {
				...
				main: function (element, settings) {
					...
					$(element).on("keypress", function(e){
						...
						if (keycode !== 0) {
							if ((keycode === 44) && (!chars.match(/^\s*$/))) {
								taglist.push(chars);

								createFancyTagItem(e, target, taglist);
								chars = "";
							}

							if ((keycode !== 44) && (!String.fromCharCode(keycode).match(/^\s*$/))){
								chars += String.fromCharCode(keycode).trim();
							}
						}
						...
						var keycode = e.which || e.keyCode;
					  	...
					  	if ((keycode === 8) || (keycode === 48)){
					  		...
					  		if (!e.target.hasChildNodes()){
						  		if (lastTagItem === null) {
									if (fancyTagList.length !== 0){

							  			lastTagItem = fancyTagList.pop();
					...
					var createFancyTagItem = function(e, target, taglist){
						var tag = null;
						tag = taglist.shift();
